  ...
  "rounded-xl border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        gold: "bg-card border-primary/30 shadow-[0_4px_30px_hsl(38_72%_50%/0.3)] hover:shadow-[0_0_60px_hsl(38_72%_50%/0.4)]",
        gradient: "bg-gradient-to-br from-card to-muted border-border/50",
        elevated: "bg-card border-border shadow-[0_8px_32px_hsl(0_0%_0%/0.4)] hover:shadow-[0_4px_30px_hsl(38_72%_50%/0.3)]",
      },
    },
    defaultVariants: {
      variant: "default",
